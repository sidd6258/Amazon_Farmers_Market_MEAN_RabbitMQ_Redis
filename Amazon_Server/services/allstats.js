...
function revenuestats(msg, callback){
	var res = {};
	var gettrip="select substr(Bill_date,1,10),Sum(Total_amount) as sum from Billing where substr(Bill_date,1,10) between '"+msg.sdate+"' and '"+msg.edate+"' group by substr(Bill_date,1,10);";
